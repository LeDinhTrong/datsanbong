<?php                                                                                      
	class UserDA{				
		public function UserDataAccess($what, $param){ 			
            switch ($what) {                                                                 
                //******************p500User************************             
                // p500User(id,Name,Phone,Email,Password,Avatar_Url,Token)
                ...
                case 501: {                                                                        
                    return "INSERT INTO p500User(Name,Phone,Email,Password,Avatar_Url,Token)
                            VALUES('$param->Name','$param->Phone','$param->Email','$param->Password','$param->Avatar_Url','$param->Token')";                               
                }                                                                                  
                                                                                                   
                // Update data p500User
                case 502: {
                    return "UPDATE p500User SET Name='$param->Name',Phone='$param->Phone',Email='$param->Email',Password='$param->Password',Avatar_Url='$param->Avatar_Url',Token='$param->Token'
                            WHERE id='$param->id'";                                                 
                }                                                                                  
