	...
	class FootbalFieldDA{				
		public function FootbalFieldDataAccess($what, $param){ 			
            switch ($what) {                                                                 
                ...
                case 705: {                                                                        
                    return "SELECT *                                                                              
                            FROM (SELECT idField FROM p700FootbalField $param->condition ORDER BY id LIMIT $param->offset, $param->limit) T1     
                            INNER JOIN p700FootbalField T2 ON T1.idField = T2.idField";                                     
                }                                                                                                 
