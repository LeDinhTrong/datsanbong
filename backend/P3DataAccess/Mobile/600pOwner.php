<?php                                                                                      
	class OwnerDA{				
		public function OwnerDataAccess($what, $param){ 			
            switch ($what) {                                                                 
                //******************p600Owner************************             
                // p600Owner(id,Name,Phone,Email,Password,Avatar_Url)
                ...
                case 601: {                                                                        
                    return "INSERT INTO p600Owner(Name,Phone,Email,Password,Avatar_Url)
                            VALUES('$param->Name','$param->Phone','$param->Email','$param->Password','$param->Avatar_Url')";                               
                }                                                                                  
                                                                                                   
                // Update data p600Owner
                case 602: {
                    return "UPDATE p600Owner SET Name='$param->Name',Phone='$param->Phone',Email='$param->Email',Password='$param->Password',Avatar_Url='$param->Avatar_Url'
                            WHERE id='$param->id'";                                                 
                }                                                                                  
