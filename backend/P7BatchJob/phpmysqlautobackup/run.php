...
1.6.3      Oct 2012 - corrected bug with CONSTRAINT and added CHARSET - suggested by: vit.bares@gmail.com
1.6.4      Nov 2019 - replacement for deprecated function "each", now using "each_item"
********************************************************************************************/
$phpMySQLAutoBackup_version="1.6.4";
// ---------------------------------------------------------
// you must add your details below:
$db_server = "localhost"; // your MySQL server - localhost will normally suffice
$db = "tool"; // your MySQL database name
