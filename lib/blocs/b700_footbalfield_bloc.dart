...
class FootbalFieldBloc {                                                                                                                                                            
  ...
  Stream<List<M700FootbalFieldModel>> get footbalFieldStream700 => _footbalFieldSubject700.stream;       
																																																
  // for what 705                                                                                                                                                                
  List<M700FootbalFieldModel> listFootbalField705 = [];                                                                                    
  final _footbalFieldSubject705 = PublishSubject<List<M700FootbalFieldModel>>();                                                      
  Stream<List<M700FootbalFieldModel>> get footbalFieldStream705 => _footbalFieldSubject705.stream;   
